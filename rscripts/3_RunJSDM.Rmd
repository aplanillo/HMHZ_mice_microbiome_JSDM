...
rL1 <- HmscRandomLevel(units = levels(all_data$jS_year))
rL2 <- HmscRandomLevel(sData = xyData, units = levels(all_data$locID))
rL3 <- HmscRandomLevel(units = levels(all_data$jS_mouseID))
...
model_wd <- paste0(getwd(), "/output/jSDM_20240212")
