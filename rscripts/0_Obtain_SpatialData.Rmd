...
writeRaster(road_dist_m, paste0(geoproc_wd, "/distance_to_roads_germany_2018_10m_3035.tif"), overwrite = TRUE)
```
...
plot(path_dist_m)
writeRaster(path_dist_m,  paste0(geoproc_wd, "/distance_to_paths_germany_202218_10m_3035.tif"), overwrite = TRUE)
```
